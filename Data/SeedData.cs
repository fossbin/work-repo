        ...
        using (var conn = DatabaseHelper.GetConnection())
        {
            ...
            using (var cmd = conn.CreateCommand())
            {
                ...
                if (adminCount == 0)
                {
                    ...
                    cmd.ExecuteNonQuery();
                    Console.WriteLine("Admin dummy data inserted successfully.");
                }
                else
                {
                    Console.WriteLine("Admin data already exists, skipping insertion.");
                }
                ...
                if (userCount == 0)
                {
                    ...
                    cmd.ExecuteNonQuery();
                    Console.WriteLine("User dummy data inserted successfully.");
                }
                else
                {
                    Console.WriteLine("User data already exists, skipping insertion.");
                }

                // Check and insert Vehicles data
                ...
                if (vehicleCount == 0)
                {
                    ...
                    cmd.ExecuteNonQuery();
                    Console.WriteLine("Vehicle dummy data inserted successfully.");
                }
                else
                {
                    Console.WriteLine("Vehicle data already exists, skipping insertion.");
                }

                // Check and insert Bookings data
                ...
                if (bookingCount == 0)
                {
                    ...
                    cmd.ExecuteNonQuery();
                    Console.WriteLine("Booking dummy data inserted successfully.");
                }
                else
                {
                    Console.WriteLine("Booking data already exists, skipping insertion.");
                }
            }
        }
    }
